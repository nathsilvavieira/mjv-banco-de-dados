...
/*
    ...
    Musica musica6 = new Musica();
    musica6.setNome("All Star");
    musica6.setAlbum("Nando Reis - Voz e Violao - No Recreio");
    musica6.setArtista("Nando Reis");
    musica6.setDuracao(3.47);
    musica6.setCompositor("Nando Reis");
    musica6.setGenero("MPB");
    musica6.setInternacional(false);
